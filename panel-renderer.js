...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function setupEventListeners() {
        ...
        // 위젯에서 메모 업데이트 이벤트
        window.electronAPI.onMemoUpdateFromWidget((data) => {
            const { id, text } = data;
    ...
    async function renderMemos() {
        ...
        filteredMemos.forEach((memo) => {
            ...
            if (memo.isWidget && !activeFilters.searchTerm) return;
            ...
            viewModeDiv.innerHTML = convertMarkdownToHTML(memo.text);
            ...
            // 내용 변경 시 저장
            editModeDiv.addEventListener('blur', (event) => {
                ...
                if (memoToUpdate && memoToUpdate.text !== newText) {
                    ...
                    viewModeDiv.innerHTML = convertMarkdownToHTML(newText);
                    saveMemosToStorage();
                }
